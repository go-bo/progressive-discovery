          ...
          <ContextShelf theme={theme}>
            {contextItems.map(item => (
              <Chip
                ...
                icon={item.icon}
                size={Chip.SIZES.M}
                onDelete={() => handleRemoveContextItem(item.id)}
              >
                {item.label}
              </Chip>
            ))}
                ...
                <span>
                  <Dropdown
                    list={[
                      ...
                      { value: 'selected-text', label: 'Selected Text', leftIconType: Icon.TYPES.TEXT_SELECTION_OUTLINE },
                      { value: 'file', label: 'File...', leftIconType: Icon.TYPES.FOLDER_OUTLINE },
                      { value: 'knowledge-base', label: 'Knowledge Base', leftIconType: Icon.TYPES.BOOK_OUTLINE },
