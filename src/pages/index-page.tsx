...
const ALL_DEMOS: DemoCard[] = [
  ...
  {
    title: 'Design Specs',
    description: 'Catalog of design spec components, patterns, and templates. Source of truth for atomic design structure.',
    path: '/design-specs',
  ...
  {
    title: 'Help Center: Separate Experiences',
    description: 'AI Assistant and Support as distinct panel experiences with dedicated UIs and flows.',
    path: '/help-center-separate',
    icon: Icon.TYPES.HELP_OUTLINE,
    category: 'prototype',
  },
  {
    title: 'Help Center Rev2',
    description: 'Help Center revision 2 - iterating on the separate experiences concept.',
    path: '/help-center-rev2',
    icon: Icon.TYPES.HELP_OUTLINE,
    category: 'prototype',
  },
  {
    title: 'Time',
    description: 'Time product overview with time-specific sidebar, status tiles, timeline table, and recipe templates.',
    path: '/time',
    icon: Icon.TYPES.OVERTIME_POLICY_OUTLINE,
    category: 'prototype',
  },
  {
    title: 'Spend',
    description: 'Finance/Spend product overview with balance card, spend charts, and spend-specific recipe templates.',
    path: '/spend',
  ...
  {
    title: 'Offsite 2026',
    description: 'Progressive discovery prototype for the 2026 offsite presentation.',
    path: '/offsite-2026',
